...
export const festivals: Festival[] = [
  ...
  { name: 'GenreBlast Film Festival', url: 'https://www.genreblast.com/', date: 'September 3–6, 2026', recognition: 'Official Selection', laurelDark: '/media/festivals/genreblast-dark.png', laurelLight: '/media/festivals/genreblast-light.png' },
