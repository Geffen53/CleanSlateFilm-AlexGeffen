...
export const festivals: Festival[] = [
  { name: 'Midwest Weirdfest', url: 'https://www.midwestweirdfest.com/2026-winning-films', location: 'Eau Claire, Wisconsin', date: 'March 5–8, 2026', recognition: 'Best Short Thriller', laurelDark: '/media/festivals/midwest-dark.png', laurelLight: '/media/festivals/midwest-light.png' },
  ...
  { name: 'GenreBlast Film Festival', url: 'https://www.genreblast.com/', date: 'September 3–6, 2026', recognition: 'Official Selection', laurelDark: '/media/festivals/genreblast-award.png', laurelLight: '/media/festivals/genreblast-award.png' },
